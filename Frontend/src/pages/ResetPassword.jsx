          ...
          {success ? (
            <div className="text-center space-y-4">
              ...
              <div className="pt-2">
                <Link
                  to="/login"
                  className="inline-block py-2 px-4 rounded-lg bg-emerald-600 text-white font-semibold text-sm hover:bg-emerald-700 transition"
                >
                  Sign In Now
                </Link>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="cpass" className="block text-sm font-medium text-slate-700">
