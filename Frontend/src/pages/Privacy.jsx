      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white/95 border border-slate-200/90 rounded-2xl p-8 sm:p-10 shadow-sm space-y-6 text-sm text-slate-600 leading-relaxed">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Privacy Policy & PII Redaction Charter</h1>
              <p className="text-xs text-slate-500">Effective Date: September 2026 | Version 3.0.0</p>
            </div>
          </div>

          <section className="space-y-3 pt-4 border-t border-slate-200">
            <h2 className="text-base font-bold text-slate-900">1. Demographic Shield & Automated PII Cloaking</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-bold text-slate-900">2. Data Retention & GDPR Subject Rights</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-bold text-slate-900">3. Immutable Audit Trails & Non-Disclosure</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-bold text-slate-900">4. Data Security & Storage Architecture</h2>
            <p>
