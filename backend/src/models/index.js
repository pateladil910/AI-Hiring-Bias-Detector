...
const Job = sequelize.define('Job', {
  ...
  level: { type: DataTypes.STRING, defaultValue: 'Mid-level' },
  employmentType: { type: DataTypes.STRING, defaultValue: 'Full-time' },
  workMode: { type: DataTypes.STRING, defaultValue: 'Hybrid' },
  ...
  deadline: { type: DataTypes.STRING, defaultValue: null },
  skills: { type: DataTypes.JSON, defaultValue: [] },
  fairnessSettings: { type: DataTypes.JSON, defaultValue: { blindMask: true, biasCheck: true, sandbox: false, audit: true } },
  companyName: { type: DataTypes.STRING, defaultValue: null },
  biasScore: { type: DataTypes.FLOAT, defaultValue: null },
  skillProfileJson: { type: DataTypes.JSON, defaultValue: null },
  ...
  try {
    if (sequelize.getDialect() === 'sqlite') {
      ...
      const safeQueries = [
        ...
        'ALTER TABLE jobs ADD COLUMN salaryMin INTEGER;',
        ...
        'ALTER TABLE jobs ADD COLUMN fairnessSettings JSON;',
        'ALTER TABLE jobs ADD COLUMN companyName TEXT;',
